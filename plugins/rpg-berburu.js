...
`
      ...
      [null, null]
			...
			conn.sendButton (m.chat, hsl, botdate, null, [['Nih Hasil Berburu', 'Hasil Berburu']], m)
		}, 20000)
      ...
      [null, null]
			...
			conn.sendButton (m.chat, `${conn.getName(m.sender)} Nah ini dia`, botdate, null, [['Nih Ini Dia Berburu', 'ini ngab']], m)
		}, 18000)
      ...
      [null, null]
			...
			conn.sendButton (m.chat, `${conn.getName(m.sender)} ......`, botdate, null, [['.......', '...']], m)
		}, 15000)
      ...
      [null, null]
			...
			conn.sendButton (m.chat, `${conn.getName(m.sender)} Dapet nih..`, botdate, null, [['Dapet Nih', 'Hore Dapet']], m)
		}, 14000)
      ...
      [null, null]
			...
			conn.sendButton (m.chat, `${conn.getName(m.sender)} Sedang berburu...`, botdate, null, [['Sedang Berburu', 'Berburu Kuy']], m)
		}, 0)
